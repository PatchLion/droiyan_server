// BadukDir.h : main header file for the BADUKDIR application
//
...
// Archive Operators
	...
	CMsg&		operator<<( unsigned char	arg );
	CMsg&		operator<<( short			arg );
	CMsg&		operator<<( unsigned short	arg );
...
public:
	...
	{ return (m_fCheckTimeouts && dwTimeOut && 
		dwCurrentTime - m_dwLastTime > dwTimeOut); }
...
/////////////////////////////////////////////////////////////////////////////
// CBaseCom:
// See BadukDir.cpp for the implementation of this class
//
...
class CBadukDirApp : public CWinApp
{
public:
	CBadukDirApp();
