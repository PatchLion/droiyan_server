 ...
 */
template <typename T>
struct is_boost_intrusive_ptr : public boost::mpl::false_ { ; };

template <typename T>
struct is_boost_intrusive_ptr< boost::intrusive_ptr<T> > : public boost::mpl::true_ { ; };

template <typename T>
struct is_boost_intrusive_ptr< boost::intrusive_ptr<T> & > : public boost::mpl::true_ { ; };

template <typename T>
struct is_boost_intrusive_ptr< const boost::intrusive_ptr<T> > : public boost::mpl::true_ { ; };
