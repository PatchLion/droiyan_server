 ...
 */
template <typename T>
struct is_qt_map : public boost::mpl::false_ { ; };

template <typename Key, typename Value>
struct is_qt_map< QMap<Key, Value> > : public boost::mpl::true_ { ; };

template <typename Key, typename Value>
struct is_qt_map< QMap<Key, Value> & > : public boost::mpl::true_ { ; };

template <typename Key, typename Value>
struct is_qt_map< const QMap<Key, Value> > : public boost::mpl::true_ { ; };
