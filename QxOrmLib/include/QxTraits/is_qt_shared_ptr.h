 ...
 */
template <typename T>
struct is_qt_shared_ptr : public boost::mpl::false_ { ; };

template <typename T>
struct is_qt_shared_ptr< QSharedPointer<T> > : public boost::mpl::true_ { ; };

template <typename T>
struct is_qt_shared_ptr< QSharedPointer<T> & > : public boost::mpl::true_ { ; };

template <typename T>
struct is_qt_shared_ptr< const QSharedPointer<T> > : public boost::mpl::true_ { ; };
