...
public:
   ...
   QxDao_Helper(T & t, QSqlDatabase * pDatabase, const QString & sContext, qx::IxSqlQueryBuilder * pBuilder) : IxDao_Helper() { Q_UNUSED(t); m_pQueryBuilder.reset(pBuilder); init(pDatabase, sContext); }
